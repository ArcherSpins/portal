...
import LinkIconButton from 'ui-kit/LinkIconButton';
...
storiesOf('LinkIconButton', module)
.addDecorator(story => (
    ...
    chapters: [
        {
            sections: [
                {
                    title: 'Default',
                    sectionFn: withDecorator(<LinkIconButton onClick={onClick}>
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
                ...
                {
                    title: 'Disabled',
                    sectionFn: withDecorator(<LinkIconButton disabled={true} onClick={onClick}>
                        <svg
                            width="15"
                            height="12"
                            viewBox="0 0 15 12"
